...
/// all - currently just where recordings are saved. The Processing tabs (Process Parameters/Image
/// Enhancement/Image Selection) that used to live here have moved onto the Process view itself, as a
/// dockable right-hand panel, editing <c>ProcessParams</c> directly where it's actually used rather
/// than in a separate screen - see <c>ProcessViewModel</c>'s own doc comment.
/// </summary>
